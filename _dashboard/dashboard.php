...
<head>
  ...
  <script src="https://kit.fontawesome.com/62500bd1d6.js" crossorigin="anonymous"></script>
  <!-- Material Kit CSS -->
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <a href="index.php" class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="true" aria-label="Toggle navigation"><i style="color: black;" class="fa-solid fa-arrow-left"></i></a>
          <!-- <button class="navbar-toggler" oncl type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="true" aria-label="Toggle navigation" >
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="copyright ">
            ...
            </script>, made with <i class="material-icons">favorite</i> by Mitchell, Igo and Jelle.
          </div>
          <!-- your footer here -->
        </div>
      </footer>
